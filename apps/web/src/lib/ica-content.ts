...
const FEE_TABLE: IcaParagraph = {
  type: "table",
  headers: ["Sale Price", "E&O Supplement", "Total Broker Fee"],
  rows: [
    ["$0 – $1,000,000", "$0", "$990"],
...
export const ICA_SECTIONS: IcaSection[] = [
  ...
  },
  {
    ...
    content: [
      ...
      { type: "sub", id: "7.2", boldLead: "Flat Transaction Fee.", text: [
        ...
        { bold: "$990" },
        ", inclusive of Errors & Omissions (E&O) insurance coverage as described in Section 9 for sale values up to and including $1,000,000. For transactions exceeding $1,000,000, an E&O Supplement is added to the base fee.",
      ] },
      { type: "p-bold", text: "E&O Supplement: $400 per $500,000 (or fraction thereof) of sale price over $1,000,000." },
      FEE_TABLE,
  ...
  },
  {
    ...
    content: [
      { type: "sub", id: "9.1", text: "Broker maintains an Errors & Omissions (E&O) insurance policy covering real estate transactions brokered through CnC Realty. Coverage limits are $1,000,000 per claim and $1,000,000 aggregate. The flat transaction fee described in Section 7.2 includes E&O coverage for transactions with a sale value up to and including $1,000,000. For transactions exceeding $1,000,000, the E&O Supplement described in Section 7.2 covers the additional E&O exposure — no further E&O fee is charged beyond what is specified in the fee schedule." },
  ...
  },
  {
    ...
    content: [
      ...
      { type: "p", text: "Upon termination or transfer to another brokerage, all active listings and pending transactions remain the property of Broker and shall stay with CnC Realty unless Broker and Associate-Licensee execute a written referral agreement transferring them to Associate-Licensee’s new brokerage." },
    ],
  },
  {
  ...
  {
    num: "24", title: "Harassment and Discrimination Policy",
    content: [
      { type: "p", text: "CnC Realty strictly prohibits harassment and discrimination of any kind, including on the basis of race, color, religion, sex, gender identity, sexual orientation, national origin, ancestry, citizenship status, marital status, pregnancy, age, disability, or any other characteristic protected by applicable state or federal law. This policy applies to all interactions among Associate-Licensees, Broker, employees, clients, vendors, and any other party doing business with CnC Realty. Associate-Licensee acknowledges that any violation of this policy constitutes grounds for immediate termination of this Agreement, and that Associate-Licensee may be held personally liable for conduct that violates applicable harassment or discrimination laws." },
    ],
  },
  {
    num: "25", title: "Waiver",
    content: [
      { type: "p", text: "No failure or delay by Broker in enforcing any provision of this Agreement, and no failure by Broker to act upon any default by Associate-Licensee, shall be construed as a waiver of Broker's right to enforce that provision or any other provision of this Agreement in the future." },
    ],
  },
  {
    num: "26", title: "Mentorship Program",
    content: [
      { type: "sub", id: "26.1", text: "CnC Realty offers an optional Mentorship Program for Associate-Licensees with little or no transactional experience. Participation in the Mentorship Program requires a separate written Mentorship Agreement signed by the Associate-Licensee, the assigned Mentor, and Broker." },
      { type: "sub", id: "26.2", text: [
        "Under the Mentorship Program, the commission split is ",
        { bold: "75% to Associate-Licensee and 25% to the assigned Mentor" },
        ". The flat transaction fee (Section 7.2), inclusive of any applicable E&O Supplement, and the CnC TC Service fee (Section 8, if applicable) are deducted from the gross commission ",
        { bold: "before" },
        " the 75/25 split is applied to the remaining commission.",
      ] },
      { type: "sub", id: "26.3", text: [
        "The 75/25 mentorship split applies to ",
        { bold: "both sides" },
      ...
      { type: "sub", id: "26.4", text: "Upon successful completion of the Associate-Licensee’s first closed transaction under the Mentorship Program, the Associate-Licensee will transition to 100% commission (less the applicable flat transaction fee) for all subsequent transactions, unless otherwise agreed in writing." },
    ],
  },
  {
    num: "27", title: "Entire Agreement",
    content: [
  ...
  {
    num: "28", title: "Associate-Licensee Agrees and Understands That",
    content: [
