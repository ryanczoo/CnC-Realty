      ...
      {!readOnly && (
        <div className="border-t border-[#1B1B1B]/10 pt-4">
          <textarea
            ...
            rows={3}
            className="w-full rounded-lg border border-[#1B1B1B]/10 bg-white px-3 py-2 text-sm text-[#1B1B1B] placeholder:text-[#1B1B1B]/25 focus:outline-none focus:ring-2 focus:ring-[#9E8C61]/30"
          />
